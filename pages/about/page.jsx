...
const About = () => {
  return (
    <div id='about' className="mb-20 w-full text-slate-400">
      ...
      <div className='p-5'>
        <p data-aos='fade-up'>I started my computer career early 2000 (year 2000) I took Computer Programming at that time Windows 95 was not yet born. Programming lessons were Cobol, Fortran, Pascal I think this were the early birds in computer programming.Sadly I work as a salesman in a company.</p>
        <br />
        <p data-aos='fade-up'>Fast forward in 2013. I was able to start a small print shop in my hometown and I was able to got a hands-on again in Graphic Design and in 2022 while watching youtube videos I learn about the mighty VS-CODE that helps programmers, developer simplifying coding, error handling and testing, and that&apos;s it that gave me the boost to continue my programming path.</p> <br />
        <p data-aos='fade-up'>
